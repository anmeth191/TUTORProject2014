...
echo 'Conexion Fallida' . mysqli_connect_error();
    ...
    $cadena=$_SESSION['usuario'];
    $sql = "SELECT * FROM curso INNER JOIN tutor WHERE nivel='principiante' AND tutor.id_tutor=curso.id_curso ORDER BY `id_curso` ASC";
...
echo 'Conexion Fallida' . mysqli_connect_error();
  ...
  $sql = "SELECT * FROM curso INNER JOIN tutor WHERE nivel='intermedio' AND tutor.id_tutor=curso.id_curso ORDER BY `id_curso` ASC";
  $stm = $conexion->query($sql);
  while ($datos = mysqli_fetch_array($stm))
  {
  ?>
...
echo 'Conexion Fallida' . mysqli_connect_error();
  ...
  $sql = "SELECT * FROM curso INNER JOIN tutor WHERE nivel='avanzado' AND tutor.id_tutor=curso.id_curso ORDER BY `id_curso` ASC";
  $stm = $conexion->query($sql);
  while ($datos = mysqli_fetch_array($stm))
  {
  ?>
  ...
  ?>
   ...
   <img width="150" height="150"  class="circle responsive-image " src="data:image/jpg;base64,<?php echo base64_encode($datos["fotot"]);?>"/>
    <div class="card-content">   
	 ...
	 <div class="card-action">
            <a class="pink-text center-align" href = "formulariomail.php?nombret=<?php echo ($datos['nombret']);?> " class="blue-text"><i class="material-icons">email</i> Enviar Email</a>            
</div>
</div>
     <?php  
  }    
