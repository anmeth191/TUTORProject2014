...
$sql = "INSERT INTO userss  ( nombres , apellidos, carne , carreras , turnos , correo , contrasena,imagenu ) VALUES ('".$nombre."' , '".$apellido."', '".$carnet."' , '".$carrera."' , '".$turno."' , '".$email."' , '".$password."' , '".$ruta."')";
