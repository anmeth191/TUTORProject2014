...
echo 'Conexion Fallida' . mysqli_connect_error();
  ...
  ?>
	...
	{ 
	?>
	<a class="btn-floating red lighten-2" href="<?php echo($datos["archivo"]);?>" target="_blank"> <i class="material-icons">file_download</i></a>
	<?php
	  }
	 else
	 {
...
<form method="POST" id="form_ajax" action="forop.php" enctype="multipart/form-data">
