...
echo 'Conexion Fallida' . mysqli_connect_error();
 ...
 // 
  $sql = "SELECT * FROM userss WHERE identificador=0 AND id_usuario='$ide'";
...
<div class="col s12">
    ...
    <h1>Modificar registro del estudiante </h1>
    <div id="mensaje"></div>
<form method="POST" id="form_ajax" action="<?php echo $_SERVER["PHP_SELF"] ?>">
    ...
    <input class="btn blue" type="submit" id="boton_validar" value="Modificar Estudiante"> <a href="verestudiantes.php" id="vere" class="btn-large btn-floating waves-effect waves-light"><i class="material-icons blue">apps</i></a>
