...
else if($data["identificador"]==1)
{  
  
  header("Location: paginatutor.php"); 
  exit();
}
}
}
...
<head>
   <!--Import Google Icon Font-->
	...
	<li><a class="waves-effect waves-light" href="registro.php">Crea una Cuenta</a></li>  
  ...
  <div class="section">
   ...
   <form class="col s6" method="POST" id="form_login" action="<?php echo $_SERVER["PHP_SELF"] ?>">
	   ...
	   <h2 class="center-align"><img src="images/fondologin.jpg" class=" circle responsive-img" height="650" width="650"></h2>
          ...
          <label for="icon_prefix">Carnet de estudiante</label>
	...
	<button type="button" id="enviarr" class="waves-effect waves-light btn blue darken-3  z-depth-4" value="Enviar">Log in </button>	
		...
		<a href="registro.php" class="center-align">No te has registrado aun ?</a>
...
<script>
 ...
 var url = "valogin.php"; // El script a dónde se realizará la petición.
    $.ajax({
           type: "POST",
           url: url,
